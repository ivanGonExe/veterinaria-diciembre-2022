...
{{-- <div class="texto">
  ...
  <img class="btn-whatsapp" src="./iconos/whatsapp.png" width="64" height="64" alt="WhatsApp" onclick="{{$whatsapp}}">
   </div> --}}

<!--Social SiderBar-->
<ul id="social-sidebar">
<?php 
  $whatsapp ="window.location.href='https://wa.me/".$empresa[0]->celular."?text=Hola!%20Estoy%20interesado%20en%20tu%20servicio'";
?>

   <a class="entypo-chat" onclick="{{$whatsapp}}"><span>WhatsApp</span></a>
