  ...
  <div class="formulario__grupo-input px-2">
    ...
    <div class="mb-3">
        <div class="formulario__grupo  w-90 " id="grupo__vencimiento" title="Fecha de vencimiento del lote del producto">
          ...
          <div class="formulario__grupo-input px-2">
              <input id="vencimiento" name="vencimiento" type="date" value="{{$fechaActual}}" class="form-control formulario__input" min="{{$fechaActual}}" maxlength="8" requiered>
              <i class="formulario__validacion-estado fas fa-times-circle"></i>
          </div>
          <p class="formulario__input-error">Vencimiento, solo puede contener valores númericos</p>
        </div>
    </div>
    @endif
          <br>
