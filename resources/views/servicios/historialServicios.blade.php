...
table td{
    ...
    <div class="col-4 text-center pt-5"> <button type=""class="btn btn-secondary rounded-pill m-1 p-2"  id="botonVolver"><i class="fa-solid fa-arrow-rotate-left"></i></button>   
        <a href="/DetallesServicio/create/{{$servicio->id}}" class="btn btn-primary rounded-pill " title="Nuevo registro de servicio">+ Detalle de Servicio <i class="fa-solid fa-clipboard"></i></a> </div>
    </div>
