            ...
            <div class="card shadow-sm mb-4">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <th scope="col">COPIA MÁS RECIENTE</th>
                        <th scope="col">ALMACENMIENTO USADO</th>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <span class="text-muted">
                                    ¿Está seguro de que desea eliminar la copia de seguridad creada en {{ $deletingFile['date'] }} ?
                                </span>
                                @endif
                            </div>
